...
public class MainController {
    ...
    public void showCart(ActionEvent event) throws Exception {
      ...
      public void showStockMgmt(ActionEvent event) throws Exception {
        ...
        /*productsController.updatedCartButton = cartButton;
        productsController.mainBorderPaneForCheckoutUse = mainBorderPane;
        productsController.setCart(this);*/
        mainBorderPane.setCenter(cart);
        mainBorderPane.setRight(null);
    }
    ...
    public void showHelp(ActionEvent event) {
     ...
     public void showAboutUs(ActionEvent event) {
        ...
        alert.initModality(Modality.APPLICATION_MODAL);
        alert.initOwner(helpStage);
        alert.getDialogPane().setContentText("Programmer: Carvel\n" +
"Email Address: 123abc@yahoo.com\n" +
"Phone Number: 516-111-2222\n" +
"Address: XYZ Avenue, Main Stree, NY 11664.");
        alert.getDialogPane().setHeaderText(null);
        alert.showAndWait().filter(response -> response == ButtonType.CLOSE);        
    }
}